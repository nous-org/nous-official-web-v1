  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 md:px-3 px-4">
        <h2 className="text-4xl font-bold md:text-4xl mb-4 text-black dark:text-white max-w-4xl">
          Nous it's more than a company
        </h2>
        <p className="text-neutral-700 dark:text-neutral-300 text-md md:text-lg lg:max-w-[40%] md:max-w-[80%] max-w-[90%]">
