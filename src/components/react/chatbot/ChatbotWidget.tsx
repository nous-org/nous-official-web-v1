...
const copy = {
  ...
  es: {
    ...
    emptyText:
      "Soy el agente de soporte con IA para NOUS. Puedes preguntarme sobre NOUS, esta página, o dónde la inteligencia artificial podría crear valor para tu organización. Estoy aquí para ayudarte.",
    suggestionsLabel: "Preguntas sugeridas",
    keyboardInstruction: "Presiona Enter para enviar. Usa Shift+Enter para una nueva línea.",
    disclaimer: "La IA puede equivocarse. Ponte en contacto con nosotros para un proyecto.",
